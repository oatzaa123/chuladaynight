  ...
  <div class="main-gallery-id">
    ...
    <div class="container" v-for="item in data" :key="item.id">
      ...
      <div class="gallery-footer">
        <img
          class="profile"
          :src="require('../../assets/images/gallery/Image 44@3X.png')"
          height="120"
        />
        <div class="footer-description">
          ...
          <div class="footer-icon">
            <div class="footer-icon-img" v-for="item in icon" :key="item">
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      gallery.value = data.value.filter((item) => item.id === route.params.id);
      setBackgroundImage(gallery.value[0].content[0].image);
    });
