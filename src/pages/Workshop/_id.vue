  ...
  <div class="main-workshop-id">
    <div class="row" v-for="item in data" :key="item._id">
      ...
      >
        ...
        <div class="icon">
          <img
            @click="openUrl(`https://www.google.com/maps/search/?api=1&query=`, {lat: item.contact.location.latitude, lng: item.contact.location.longitude})"
            :src="require('@/assets/images/gallery/Group 128.svg')"
            width="40"
            height="40"
          />
          <div class="icon-img">
            <img :src="require('@/assets/images/icons/Group 327@2x.png')" width="40" height="40" @click="openUrl('https://www.facebook.com', item.contact.facebook.trim())" />
            <img :src="require('@/assets/images/icons/Group 344@2x.png')" width="40" height="40" @click="openUrl('https://www.instagram.com', item.contact.instagram.trim())" />
            <img :src="require('@/assets/images/icons/Group 328.svg')" width="40" height="40" />
          </div>
        </div>
      </div>
    </div>
