    ...
    <div class="contact">
        <div class="contact-group">
            <div class="row">
                ...
                <div
                    class="col-lg-4 col-md-6 col-sm-6 col-xs-12 google-culture"
                >
                    <div class="icon">
                        <img
                            :src="
                                require('@/assets/images/home/footer/Image 58.png')
                            "
                            alt=""
                        />
                    </div>
                    <div>
                        ...
                        <div style="color: #1ba7ff">Google art & Culture</div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 icon-social">
