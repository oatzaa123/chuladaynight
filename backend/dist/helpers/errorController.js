...
var handleDuplicateFieldsDB = function handleDuplicateFieldsDB(err) {
  var value = err.errmsg.match(/((?=(\\?))\2.)/)[0];
...
var handleJWTError = function handleJWTError() {
  return new _errorHandler.default("Invalid token. Please login again!", 401);
};

var handleJWTExpiredError = function handleJWTExpiredError() {
  return new _errorHandler.default("Your token has expired! Please login again.", 401);
};
